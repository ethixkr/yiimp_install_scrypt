...
# Modified by : chilledgamer1985 (https://github.com/chilledgamer1985/yiimp_install_scrypt)
# Web: theminingpool.co.uk
#
# Program:
...
################################################################################
    ...
    # Compil Blocknotify
    cd ~
    hide_output git clone https://github.com/chilledgamer1985/yiimp
